...
def main():
    ...
    model_args = ModelArguments(model_name_or_path='/kaggle/input/rumodernbert-base/RuModernBERT-base', model_type=None,
                            config_name='/kaggle/input/rumodernbert-base/RuModernBERT-base/config.json', tokenizer_name='/kaggle/input/rumodernbert-base/RuModernBERT-base/tokenizer.json', cache_dir=None, use_fast_tokenizer=True,
                            model_revision='main',
